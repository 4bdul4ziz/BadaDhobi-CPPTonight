...
import Metamask from '../../images/auth/metamask.webp';
import google from '../../images/auth/google.svg';
import loginPic from '../../images/auth/log.png';
					...
					<div className="signin-signup">
						<form onSubmit={onSubmitOld} className="sign-in-form">
							...
							<div className="social-media">
								...
								<button className="social-icon" onClick={auth.signInWithMeta}>
									<img src={Metamask} width="27px" />
									<span className="mx-2">Sign in with Metamask </span>
								</button>
