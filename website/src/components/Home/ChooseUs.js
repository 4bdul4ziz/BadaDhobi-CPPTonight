import { faLeaf, faLiraSign, faMedal, faMoneyBillAlt, faSoap, faTruck ,faSmile} from '@fortawesome/free-solid-svg-icons';
...
const service = [
	{
		src: <FontAwesomeIcon icon={faSmile} /> ,
		name: 'Convenience',
		title: 'Our User interface is very intuitive and engaging made for a smooth operation',
	},
	{
	...
	},
	{
		...
		name: 'Affordable',
		title: 'Our service is very helpful for bachelors and students who dont want to invest in expensive appliances .No Additional Cost! You pay just as same as the price set by your selected laundry vendor.'
	},
	{
		src: <FontAwesomeIcon icon={faLeaf} /> ,
		name: 'Eco Friendly',
		title: 'Local residents share the same machine , therefore less electricity used and less plastic used.'
	},
	{
