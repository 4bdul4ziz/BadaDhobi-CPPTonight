				...
				<Row className="mt-3 mb-5">
					<Col md={4}>
						<div>
							...
							<div className="text-center">
								<h5 className="text-danger mt-4 mb-0">Samik Saraswat </h5>
								...
								<p className="mb-5">
									 TIPSY GANG, all my homies hate Chota Dhobi
								</p>
							</div>
						</div>
					</Col>
					<Col md={4}>
						<div>
							...
							<div className="text-center">
								<h5 className="text-danger mt-4 mb-0">Deepthi Ramesh </h5>
								...
								<p className="mb-5">
									Me and Madhav love using this every week. Our clothes are very dirty
								</p>
							</div>
						</div>
					</Col>
					<Col md={4}>
						<div>
							...
							<div className="text-center">
								<h5 className="text-danger mt-4 mb-0">Yukta Bhatti</h5>
								...
								<p className="mb-5">
									I can wear my favourite black top every week now.
								</p>
							</div>
						</div>
					</Col>
