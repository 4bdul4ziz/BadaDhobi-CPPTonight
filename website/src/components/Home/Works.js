						...
						<Timeline align="alternate">
								...
								<TimelineContent>
									<Paper elevation={3} className={classes.paper}>
										<Typography variant="h6" component="h1">
											Login using Metamask or Google
										</Typography>
									</Paper>
								</TimelineContent>
							</TimelineItem>
							<TimelineItem>
								...
								<TimelineContent>
									<Paper elevation={3} className={classes.paper}>
										<Typography variant="h6" component="h1">
											Check for available Washing machines
										</Typography>
									</Paper>
								</TimelineContent>
							</TimelineItem>
							<TimelineItem>
								...
								<TimelineContent>
									<Paper elevation={3} className={classes.paper}>
										<Typography variant="h6" component="h1">
											Select the nearest Washing machine and scan the QR code
										</Typography>
									</Paper>
								</TimelineContent>
							</TimelineItem>
							<TimelineItem>
								...
								<TimelineContent>
									<Paper elevation={3} className={classes.paper}>
										<Typography variant="h6" component="h1">
											Make payment using Matic Wallet
										</Typography>
									</Paper>
								</TimelineContent>
							</TimelineItem>
